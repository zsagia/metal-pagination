...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      ie_open('div', null, null, 'class', 'pagination' + (opt_data.elementClasses ? ' ' + opt_data.elementClasses : ''));
      ie_open('ul', null, null, 'class', 'pagination pagination-content');
    ...
    function $renderElement_(opt_data, opt_ignored, opt_ijData) {
      ie_open('li', null, null, 'class', opt_data.cssClass ? opt_data.cssClass : '', 'data-onclick', opt_data.onClick);
...
(function () {
	...
	var Pagination = function (_Component) {
		...
		function Pagination(value) {
			...
			var _this = babelHelpers.possibleConstructorReturn(this, _Component.call(this, value));

			_this.TOTAL_CONTROLS = 2;

			_this.on(Pagination.Events.CHANGE_REQUEST, _this.defaultChangeRequestFn_, true);
			return _this;
		}
   ...
   */
		...
		Pagination.prototype.findItemIndex_ = function findItemIndex_(element, items) {
			for (var i = 0; i < items.length; i++) {
  ...
  */
   ...
   */
		...
		Pagination.prototype.setterLastStateFn_ = function setterLastStateFn_(state) {
